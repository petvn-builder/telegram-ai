...
For each entity, include aliases: alternative names, nicknames, abbreviations, or shortened forms that someone might use to refer to this entity. Examples: "Peter (Ngu Phan)" → aliases: ["Peter", "Ngu Phan", "Peter Phan"]. "OpenAI" → aliases: []. "React.js" → aliases: ["React"].`,
      },
      {
        role: "user",
        content: trimmedText,
              ...
              items: {
                ...
                properties: {
                  ...
                  aliases: {
                    type: "array",
                    items: { type: "string" },
                    description: "Alternative names, nicknames, or shortened forms (e.g. ['Peter', 'Ngu Phan'] for 'Peter (Ngu Phan)')",
                  },
                  attributes: {
                    type: "object",
                    properties: {
                ...
                required: ["name", "type", "aliases", "attributes", "events", "relationships", "responsibilities"],
                additionalProperties: false,
              },
            },
          },
